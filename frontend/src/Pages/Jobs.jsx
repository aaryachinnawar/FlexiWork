...
const Jobs = () => {
    ...
    const handleSendRequest = async (jobId, clientId) => {
        ...
        try {
            await axios.post(`${VITE_APP_API}/api/jobs/apply`, {
                jobId,
                clientId,
                            ...
                            >
                                ...
                                <div className="mt-4 flex justify-between items-center">
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2 border-2 border-black shadow-[2px_2px_0_0_#000] text-white font-bold transition ${requestedJobs.has(job._id) ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'}`}
                                        disabled={requestedJobs.has(job._id)}
                                    >
